...
**The hero is a scroll-scrubbed clip** of `../Bike_5.mov` (8s), supplied by
the client. The derivative is `media/hero-scrub.mp4`. `Hero_video2.mp4` here,
`Hero_video.mp4` in `../test_2` and `main image.jpeg` are earlier hero sources,
